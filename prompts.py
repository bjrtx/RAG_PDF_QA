PROMPTS = {
    "RAG_PDF": (
        ...
        "text'.First write the page labe from the PDF:{sourcename} if"
    ...
    "RAG_PDFs_data": (
        ...
        "First, write the source file name:{sourcename} and the page label"
        "from the PDF:{sourcename}, then answer the question: {question}"
